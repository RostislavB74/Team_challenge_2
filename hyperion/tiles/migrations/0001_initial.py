...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Collection',
            fields=[
                ('id', models.IntegerField(db_column='collection_id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='TileGeometry',
            fields=[
                ('id', models.SmallIntegerField(db_column='tile_geometry_id', primary_key=True, serialize=False)),
                ('name', models.CharField(db_column='tile_geometry', max_length=255)),
            ],
            options={
